...
echo "=== 1. Liberando travamentos do dpkg ==="
...
echo "=== 3. Instalando XFCE4, Xvfb e Sunshine ==="
sudo apt-get update -y
sudo apt-get install -y xvfb x11vnc xfce4 xfce4-terminal libgbm1 libegl1-mesa wget boost1.74-python3.10 || true
